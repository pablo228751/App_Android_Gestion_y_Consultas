...
public class Verpt extends ListActivity{
    Activity context;
    HttpPost httppost;
    StringBuffer buffer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verpt);
        context=this;
        records=new ArrayList<VerComprobante_data>();
        listaVerComprobante=(ListView)findViewById(android.R.id.list);
        adapter=new VerComprobanteAdaptador(context, R.layout.lv_verpt, R.id.text_vercom_oper,	records);
        ...
        getSignature.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(Verpt.this, Firma.class);
